...
const sections = [
  ...
  { id: 'conversation', label: '对话', color: '#34d399',
    fields: [
      ...
      { key: 'conversation.typing_speed', label: '打字速度(字/秒)', type: 'number' },
  ...
  { id: 'humanity', label: '人性化', color: '#ec4899',
    fields: [
      ...
      { key: 'humanity.self_correction_probability', label: '自我纠正概率', type: 'number' },
      ...
      { key: 'humanity.humanity_filter_enabled', label: '人性滤镜', type: 'bool' },
      { key: 'humanity.inner_thought_enabled', label: '内心独白', type: 'bool' },
      { key: 'humanity.inner_thought_interval_min', label: '独白最小间隔(秒)', type: 'number' },
...
function openEdit() {
  showEdit.value = true
  // Clear and repopulate edit form
...
.toggle-dot { width: 8px; height: 8px; border-radius: 50%; background: var(--text-3); flex-shrink: 0; }
